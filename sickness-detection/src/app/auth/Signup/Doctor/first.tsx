...
export default() => {
    return(
        ...
        <div className="flex md:flex-row flex-col gap-2">
            ...
            <button className="mt-4 w-full rounded-md text-white bg-sickness-primary hover:bg-sickness-primaryText/70 active:bg-sickness-primaryText transition delay-75 duration-100 py-2 font-semibold flex justify-center items-center gap-2"> Next <ChevronsRightIcon className="h-5 w-5" /> </button>
        </>
    )
}