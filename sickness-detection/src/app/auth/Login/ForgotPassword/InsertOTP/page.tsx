        ...
        <div className="w-full flex justify-center items-center h-screen px-8 py-4">
            <div className="w-[32rem] px-8 py-4 rounded-md border border-sickness-border bg-white flex flex-col gap-4 items-center">
                ...
                <div className="w-full">
                    ...
                    <input type="text" className="outline-none border focus:border-sickness-primary text-sickness-gray text- pl-2 md:py-2 py-1 rounded-md w-full border-sickness-border" placeholder="example@gmail.com" />
                </div>
