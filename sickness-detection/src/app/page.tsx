    ...
    <div className="flex flex-col">
      <div className="LandingImage h-screen flex justify-center items-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <button className={`${pageLoading ? "bg-sickness-primary/80" : "mayablue-glassmorphism"} px-8 text-white py-3 mt-8 flex justify-center items-center gap-2 rounded-lg`} disabled={pageLoading} onClick={handleCLick} > Check Symptoms {pageLoading && <div className="small-white-loader" />} </button>
          </div>
